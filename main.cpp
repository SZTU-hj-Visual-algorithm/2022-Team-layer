...
int main()
{
    ...
    net_config.netname = "../fix.onnx";
    net_config.nmsThreshold = 0.6;
    net_config.confThreshold = 0.6;
    net_config.scoThreshold = 0.6;
...
//
        cv::Mat blob;
        cv::dnn::blobFromImage(src,blob,1.0/255.0,cv::Size(yolov5.INPUT_WIDTH,yolov5.INPUT_HEIGHT),cv::Scalar(0,0,0),true, false);
